function [all_segments, penup_segments, pendown_segments, separators] = segment_by_strokes_vy_criterion( Word )
%% segment_by_strokes_vy_criterion
...
%  must have a continuous sign in the Y speed.
%
% [ _all_segments_ , _penup_segments_ , _pendown_segments_ , _separators_ ] = _*segment_by_strokes_vy_criterion*_ ( _Word_ )
%
%%% Inputs
% 
...
%
    ...
    for k=1:length(all_segments_pen_up_down)
        [ ~, ~, vy ] = compute_all_speeds(all_segments_pen_up_down(k));
        j = 1;
