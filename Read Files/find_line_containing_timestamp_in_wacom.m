function [ lines_index ] = find_line_containing_timestamp_in_wacom( filepath , timestamps )
    ...
    for k=1:n_timestamps
        ...
        for j = j_search_start_idx:length(s{1})
            ...
            if(~isempty( line_matches ))
                ...
                % 1 is the column where the time component is stored...
                if( ~isempty(line_matches) && line_matches(1) == timestamps(k) )
