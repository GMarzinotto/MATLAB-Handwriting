function [ labels_per_stroke , labels_per_sample ] = detect_diacritic_marks( Word )
    ...
    load('SVM_diacritic_marks_boolean_model.mat') 
    
    
    [labels_on_tablet , NegLoss , PBScore , Posterior ] = predict( SVM_diacritic_marks_boolean_model , all_features );
