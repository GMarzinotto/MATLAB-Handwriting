function [ features , feature_names , struct_features ] = compute_punctuation_marks_features_for_classifier( Segment , Canonical_Lines )
%% compute_punctuation_marks_features_for_classifier
...
%                       
%
% [ _features_ , _feature_names_ , _struct_features_ ] = _*compute_punctuation_marks_features_for_classifier*_ ( _Segment_ , _Canonical_Lines_ )
%
%%% Inputs
% 
...
%%
    ...
    Distance_to_Bsaeline = mean([Segment.Y]) - polyval( Canonical_Lines.BaseLine , mean([Segment.X]) );
    ...
    struct_features.Distance_Baseline               = Distance_to_Bsaeline;
    struct_features.stds                            = [ std([Segment.X]) std([Segment.Y]) ];
