function [ labels_per_stroke , labels_per_sample ] = classify_punctuation_marks( Word )
    ...
    load('SVM_punctuation_marks_model.mat')

    
    [labels_on_tablet , NegLoss , PBScore , Posterior ] = predict(SVM_punctuation_marks_model,all_features);
