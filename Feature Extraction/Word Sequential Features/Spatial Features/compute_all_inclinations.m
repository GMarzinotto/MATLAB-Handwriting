function [ angle_deg_0_360 , angle_deg_0_180 , angle_deg_0_90 , Trigonometry ] = compute_all_inclinations(Word)
%% compute_all_inclinations
%  Computes all the local inclination values in a word struct
...
%  are removed use compute_valid_inclinations function
%
% [ _angle_deg_0_360_ , _angle_deg_0_180_ , _angle_deg_0_90_ , _Trigonometry_  ] = _*compute_all_inclinations*_ ( _Word_ )
%
%%% Inputs
% 
...
%%% Outputs
% 
% * *angle_deg_0_360*  : An array containing all the inclination angles of Word
...
%                        Size of inclinations is Word.NumSamples -1
%
...
%%
    ...
    %Trigonometric functions on the angles in [0 pi/2]
    ...
    %Trigonometric hyperbolic functions on the angles in [0 pi/2]
