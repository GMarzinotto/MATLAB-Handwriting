function [ ] = plot_jerk_y(Word,plotStyle,MaxVal)
%% plot_jerk_y
%  Plots a word struct using a color scale that represents Y jerk
%
% [  ] = _*plot_jerk_y*_ ( _Word_ , _plotStyle_ , _MaxVal_ )
%
%%% Inputs
% 
