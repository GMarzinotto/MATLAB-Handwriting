function [ ] = plot_acceleration_x(Word,plotStyle,MaxVal)
%% plot_acceleration_x
%  Plots a word struct using a color scale that represents X acceleration
%
% [  ] = _*plot_acceleration_x*_ ( _Word_ , _plotStyle_ , _MaxVal_ )
%
%%% Inputs
% 
...
%%
	...
	[ ~ , ax, ~ ]   = compute_all_accelerations(Word);
    ModA = abs(ax);
    ...
    h.Label.String = strcat('X Acceleration (cm/s^2)');
    axis equal
