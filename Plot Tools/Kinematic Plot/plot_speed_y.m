function [ ] = plot_speed_y(Word,plotStyle,MaxVal)
%% plot_speed_y
%  Plots a word struct using a color scale that represents Y speed
%
% [  ] = _*plot_speed_y*_ ( _Word_ , _plotStyle_ , _MaxVal_ )
%
%%% Inputs
% 
...
%%
    ...
    h.Label.String = strcat('Y Speed (cm/s)');
    axis equal
