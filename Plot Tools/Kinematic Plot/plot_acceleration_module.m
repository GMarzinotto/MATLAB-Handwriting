function [ ] = plot_acceleration_module(Word,plotStyle,MaxVal)
%% plot_acceleration_module
%  Plots a word struct using a color scale that represents acceleration
%
% [  ] = _*plot_acceleration_module*_ ( _Word_ , _plotStyle_ , _MaxVal_ )
%
%%% Inputs
% 
...
%%
	...
	[ ModA ]   = compute_all_accelerations(Word);
    ...
    h.Label.String = strcat('Acceleration Module (cm/s^2)');
    axis equal
