function [ ] = plot_jerk_x(Word,plotStyle,MaxVal)
%% plot_jerk_x
%  Plots a word struct using a color scale that represents X jerk
%
% [  ] = _*plot_jerk_x*_ ( _Word_ , _plotStyle_ )
%
%%% Inputs
% 
