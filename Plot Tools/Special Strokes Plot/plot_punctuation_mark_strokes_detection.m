function [] = plot_punctuation_mark_strokes_detection( Word , plotStyle )
%% plot_punctuation_mark_strokes_detection
...
%
% [  ] = _*plot_punctuation_mark_strokes_detection*_ ( _Word_ , _plotStyle_ )
%
%%% Inputs
% 
...
%%
    ...
    labels  = detect_punctuation_marks( Word );

    
    plot_in_black_and_white( Word, plotStyle );
    hold on
    
    class_names = {'normal','punctuation'};
