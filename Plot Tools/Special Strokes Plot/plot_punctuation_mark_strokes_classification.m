function [] = plot_punctuation_mark_strokes_classification( Word , plotStyle )
%% plot_punctuation_mark_strokes_classification
...
%
% [  ] = _*plot_punctuation_mark_strokes_classification*_ ( _Word_ , _plotStyle_ )
%
%%% Inputs
% 
...
%%
    ...
    labels  = classify_punctuation_marks( Word );
